...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
   <!--  <li>
	...
	<li>
      <a class="app-menu__item active" href="ambulance-service.php">
       <i class="app-menu__icon fa fa-edit"></i>
        <span class="app-menu__label">Book Ambulance  </span>
      </a>
    </li>
	<li>
      <a class="app-menu__item active" href="create-donation.php">
       <i class="app-menu__icon fa fa-edit"></i>
